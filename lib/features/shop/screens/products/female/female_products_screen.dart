...
import 'package:do_an_mobile/features/shop/screens/products/female/widgets/female_list_products.dart';
import 'package:flutter/material.dart';

class FemaleProductsScreen extends StatelessWidget {
  const FemaleProductsScreen({super.key});
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // 3. Grid sản phẩm
          TFemaleListProducts(products: products),
        ],
      ),
    );
  }
