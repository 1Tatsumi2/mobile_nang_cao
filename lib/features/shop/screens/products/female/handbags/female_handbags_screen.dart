...
import 'package:do_an_mobile/features/shop/screens/products/female/handbags/widgets/handbags_list.dart';
import 'package:flutter/material.dart';

class FemaleHandbagsScreen extends StatelessWidget {
  const FemaleHandbagsScreen({super.key});
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // 3. Grid sản phẩm
          TFemaleHandbagsListProducts(products: products),
        ],
      ),
    );
  }
