...
import 'package:do_an_mobile/features/shop/screens/products/male/shoes/widgets/male_shoes_list_products.dart';
import 'package:flutter/material.dart';

class MaleShoesScreen extends StatelessWidget {
  const MaleShoesScreen({super.key});
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // 3. Grid sản phẩm
          TMaleShoesListProducts(products: products),
        ],
      ),
    );
  }
